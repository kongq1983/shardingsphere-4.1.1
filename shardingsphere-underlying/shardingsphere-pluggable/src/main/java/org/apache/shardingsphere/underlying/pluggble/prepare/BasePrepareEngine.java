...
public abstract class BasePrepareEngine {
    ...
    private void registerRouteDecorator() {// class org.apache.shardingsphere.core.rule.MasterSlaveRule
    ...
    private RouteDecorator createRouteDecorator(final Class<? extends RouteDecorator> decorator) {
        try { // class org.apache.shardingsphere.sharding.route.engine.ShardingRouteDecorator
